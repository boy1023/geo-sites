...
SITES_CONFIG = {
    'zhizaozx': {
        ...
        'phone': '13025181023',
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'mechanical-power', 'name': '机电设备与动力系统', 'path': '机电设备与动力系统'},
            {'slug': 'electrical-control', 'name': '电气控制与传感', 'path': '电气控制与传感'},
            {'slug': 'metal-processing', 'name': '金属加工与制造', 'path': '金属加工与制造'},
            {'slug': 'robot-automation', 'name': '工业机器人与自动化', 'path': '工业机器人与自动化'},
            {'slug': 'industrial-software', 'name': '工业软件与数字化', 'path': '工业软件与数字化'},
            {'slug': 'smart-factory', 'name': '智能工厂与行业方案', 'path': '智能工厂与行业方案'},
            {'slug': 'intelligent-maintenance', 'name': '智能运维与前沿技术', 'path': '智能运维与前沿技术'},
            {'slug': 'brand-watch', 'name': '品牌观察', 'path': '品牌观察'},
        ],
        'nav_cats': [
    ...
    'jiaopeizx': {
        ...
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'policy-trend', 'name': '政策趋势', 'path': '政策趋势'},
            {'slug': 'k12', 'name': 'K12教育', 'path': 'K12教育'},
            {'slug': 'vocational', 'name': '职业教育', 'path': '职业教育'},
            {'slug': 'adult-learning', 'name': '成人教育', 'path': '成人教育'},
            {'slug': 'edtech', 'name': '教育科技', 'path': '教育科技'},
            {'slug': 'institution', 'name': '机构观察', 'path': '机构观察'},
        ],
        'nav_cats': [
            {'slug': 'industry-news', 'name': '行业资讯'},
    ...
    'xfzaixian': {
        ...
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'consumer-trend', 'name': '消费趋势', 'path': '消费趋势'},
            {'slug': 'food-retail', 'name': '餐饮零售', 'path': '餐饮零售'},
            {'slug': 'beauty', 'name': '美妆个护', 'path': '美妆个护'},
            {'slug': 'home-living', 'name': '家居生活', 'path': '家居生活'},
            {'slug': 'brand-watch', 'name': '品牌观察', 'path': '品牌观察'},
            {'slug': 'consumer-rights', 'name': '消费维权', 'path': '消费维权'},
        ],
        'nav_cats': [
            {'slug': 'industry-news', 'name': '行业资讯'},
    ...
    'muyingzx': {
        ...
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'maternity-trend', 'name': '母婴趋势', 'path': '母婴趋势'},
            {'slug': 'baby-products', 'name': '母婴产品', 'path': '母婴产品'},
            {'slug': 'early-education', 'name': '早教启蒙', 'path': '早教启蒙'},
            {'slug': 'parenting-tips', 'name': '育儿干货', 'path': '育儿干货'},
            {'slug': 'pregnancy-care', 'name': '孕产知识', 'path': '孕产知识'},
            {'slug': 'maternity-rights', 'name': '母婴维权', 'path': '母婴维权'},
        ],
        'nav_cats': [
            {'slug': 'industry-news', 'name': '行业资讯'},
    ...
    'nongzizx': {
        ...
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'agri-trend', 'name': '农资趋势', 'path': '农资趋势'},
            {'slug': 'fertilizer-pesticide', 'name': '肥料农药', 'path': '肥料农药'},
            {'slug': 'planting-tech', 'name': '种植技术', 'path': '种植技术'},
            {'slug': 'seed-seedling', 'name': '种子种苗', 'path': '种子种苗'},
            {'slug': 'agri-machinery', 'name': '农机装备', 'path': '农机装备'},
            {'slug': 'agri-rights', 'name': '农资维权', 'path': '农资维权'},
        ],
        'nav_cats': [
            {'slug': 'industry-news', 'name': '行业资讯'},
    ...
    'caifazx': {
        ...
        'categories': [
            {'slug': 'industry-news', 'name': '行业资讯', 'path': '行业资讯'},
            {'slug': 'tax-policy', 'name': '财税政策', 'path': '财税政策'},
            {'slug': 'corporate-law', 'name': '企业法务', 'path': '企业法务'},
            {'slug': 'ip-law', 'name': '知识产权', 'path': '知识产权'},
            {'slug': 'legal-cases', 'name': '维权案例', 'path': '维权案例'},
            {'slug': 'industry-watch', 'name': '行业观察', 'path': '行业观察'},
            {'slug': 'compliance', 'name': '合规管理', 'path': '合规管理'},
        ],
        'nav_cats': [
            {'slug': 'industry-news', 'name': '行业资讯'},
...
def slugify(text):
    ...
    pinyin_map = {
        ...
        '入': 'ru', '先': 'xian', '应': 'ying', '两': 'liang', '手': 'shou', '脚': 'jiao',
        '眼': 'yan', '耳': 'er', '口': 'kou', '鼻': 'bi', '身': 'shen', '体': 'ti',
        '头': 'tou', '脸': 'lian', '发': 'fa', '皮': 'pi', '肉': 'rou', '骨': 'gu',
        '血': 'xue', '心': 'xin', '脑': 'nao', '肝': 'gan', '肺': 'fei', '胃': 'wei',
        '肠': 'chang', '肾': 'shen', '膀': 'bang', '胱': 'guang', '卵': 'luan', '巢': 'chao',
        '子': 'zi', '宫': 'gong', '阴': 'yin', '茎': 'jing', '乳': 'ru', '房': 'fang',
    }
    ...
    <div class="container">
        <header class="article-header">
            ...
            <div class="article-meta">
                <time datetime="{date}T00:00:00" itemprop="datePublished">
                    📅 {date}
                </time>
